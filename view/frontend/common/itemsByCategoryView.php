...
<section id="category" class="text-center col-12 mx-auto">
    ...
    <div class="jumbotron-categories mb-0 p-0 col-10 m-auto">
        ...
        <h1 class="text-center mt-5 mb-5 pt-5 pb-5 bg-orange text-white m-auto">
    ...
    <div>
        <?php
            foreach ($itemsCategories as $item) {
                ?>
        <article class="card mx-auto col-10 m-auto">
            ...
            ?>
                ...
                <a class="nav-link h5" href="index.php?action=cardSeller&amp;id_seller=<?= $item['id_seller']; ?>">Voir
                    la fiche
                    vendeur</a>
        </article>
        <?php

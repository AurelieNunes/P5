...
<?php ob_start(); ?>
<link href="../../public/css/seller.css" rel="stylesheet">
<link href="../../public/css/style.css" rel="stylesheet">

<!-- START THE FEATURETTES -->
<div class="row featurette">
    <h2 class="text-center h6 w-100 mt-3 featurette-heading ">Bienvenu sur ma boutique</h2>
    <div class="presentation d-flex justify-content-around">
        <p class="lead text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum praesentium
...
<section class="selectionWeek">
    <h1 class="h5 text-center mb-0">Mes Produits</h1>
    <div class="productWeek row">
        <div class="featurette-product-seller mt-5">
            <div class="img-product-seller mx-auto mt-5">
                ...
                <div class="product">
                    ...
                    <p class="description-product">Pull 100% cachemire blabla blabla <div class="link-ReadMore">
        ...
        <div class="featurette-product-seller mt-5">
            <div class="img-product-seller mx-auto mt-5">
                ...
                <div class="product">
                    <p class="title-product">Pull manches courtes</p>
                    <p class="description-product">Pull 100% cachemire blabla blabla 
                    ...
                    <p class="description-product">Pull 100% cachemire blabla blabla
                        <div class="link-ReadMore">
                            <a class="text-white nav-link"
                                href="index.php?action=post&amp;id=<?= $data[$i]['id']; ?>">Lire la
                                suite ...</a>
                        </div>
                    </p>
                    <p class="price">Prix : 25€</p>
...
<section class="reviews">
    <h1 class="h5 text-center mb-5">Avis clients</h1>
    <div id="clientReviews" class="d-flex justify-content-around">
        ...
        <div class="card border-primary mb-3" style="max-width: 20rem;">
            <div class="card-header">Pseudo</div>
            <div class="card-body">
                <h4 class="card-title">Super Produit</h4>
                <p class="card-text">
                    <div class="container-feed">
                        <div class="feedback">
                            <div class="rating">

...
<section id="createItem" class="mx-auto pt-5">
    ...
    <div id="managerBlock" class="mx-auto">
        ...
        <div id="addBlock">
            <form class="d-flex flex-column" id="addItem" action="index.php?action=upload" method="POST"
                ...
                <div class="infos d-flex">
                    ...
                    <input class="mb-2 col-2 mr-2" type="number" name="price" id="price" required />

                    <label for="size" class="mr-2">Taille</label>
                    <input class="mb-2 col-2 mr-2" type="text" name="size" id="size" required />

                    <label for="stock" class="mr-2">Stock</label>
                    <input class="mb-2 col-2 mr-2" type="number" name="stock" id="stock" required />
                </div>
                <label for="img" class="mt-5">Importer une image</label>
                <input type="file" class="mb-3" name="picture1" />

	...
	<div class="mx-auto">
		...
		<div id="updateAccountSeller">
			<form class="d-flex flex-column col-10 m-auto" action="index.php?action=submitUpdateSeller&amp;id=<?= intval($_SESSION['id']); ?>" method="POST" enctype="multipart/form-data">
				...
				<input type="text" class="mb-2 col-8" name="addressSeller" value="<?= htmlspecialchars($seller['addressSeller']); ?>" />

				<label for="cp">Code postal</label>
				<input class="mb-2 col-4" type="number" name="cpSeller" value="<?= htmlspecialchars($seller['cpSeller']); ?>" />
				...
				<input class="mb-2 col-6 mr-2" type="number" name="telSeller" value="<?= htmlspecialchars($seller['telSeller']); ?>">
